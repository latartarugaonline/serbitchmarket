...
public class DevicePos {
    ...
    public static final String ERROR_POS_INTERNAL_MESSAGE = "Errore interno del POS, verifica eventuali operazioni in sospeso sul POS e riprova.";

    public static final int ERROR_POS_UNREACH = 107;
    public static final String ERROR_POS_UNREACH_MESSAGE = "Attenzione, POS non raggiungibile oppure eventuali operazioni in sospeso su POS. Verifica che il POS sia posizionato alla voce 'SERVIZI' e riprova.";

    public static final int ERROR_POS_CONNECTION = 190;
    public static final String ERROR_POS_CONNECTION_MESSAGE = "Impossibile connettersi al POS, riprova oppure contatta il supporto.";

    public static final int ERROR_POS_CONF = 201;
    public static final String ERROR_POS_CONF_MESSAGE = "Il POS non è configurato. Contatta il supporto tecnico.";

    public static final int ERROR_POS_AUTH = 202;
    public static final String ERROR_POS_AUTH_MESSAGE = "Inserisci la carta operatore nel POS, digita il PIN e segui le istruzioni indicate.";

    public static final int ERROR_POS_ABORT = 203;
    public static final String ERROR_POS_ABORT_MESSAGE = "Autenticazione annullata esplicitamente dall’operatore.";

    public static final int ERROR_POS_ABORT_TIMEOUT = 204;
    public static final String ERROR_POS_ABORT_TIMEOUT_MESSAGE = "Operazione annullata per tempo scaduto.";

    public static final int ERROR_POS_SERVER = 205;
    public static final String ERROR_POS_SERVER_MESSAGE = "Autenticazione fallita. Contatta il supporto tecnico.";

    public static final int ERROR_POS_BUSY = 423;
    public static final String ERROR_POS_BUSY_MESSAGE = "POS già in uso, verifica eventuali operazioni in sospeso sul POS e riprova.";

    public static final int ERROR_POS_PAY_ABORT_TIMEOUT = 403;
    public static final String ERROR_POS_PAY_ABORT_TIMEOUT_MESSAGE = "Pagamento annullato per tempo scaduto.";

    public static final int ERROR_POS_PAY_ABORT = 404;
    public static final String ERROR_POS_PAY_ABORT_MESSAGE = "Pagamento annullato esplicitamente dall’operatore.";

    public static final int ERROR_POS_PAY_AUTH = 406;

    public static final String ERROR_POS_OP_ABORT_MESSAGE = "Operazione sul POS annullata, riprovare.";
    public static final String ERROR_POS_OP_TIMEOUT = "Operazione annullata per tempo scaduto.";



    public static final String USERCODE_EMPTY = "00000000";

    private final String TAG = DevicePos.class.getSimpleName();
...
//            LogWrapper.e(TAG, result.toJsonString());
